    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            if user.status == "kicked":
                await b.send_message(
                    chat_id=m.chat.id,
                    text="__Sorry You Are Banned Contact Owner __\n\n  **@kissuhelp**",
             ...
             await StreamBot.send_photo(
                chat_id=m.chat.id,
                photo="https://telegra.ph/file/54b0ae662175ac6af6075.jpg",
            ...
            await b.send_message(
                chat_id=m.chat.id,
                text="<b>sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ.ᴘʟᴇᴀsᴇ <a href='https://t.me/kissuhelp'>ᴄʟɪᴄᴋ ʜᴇʀᴇ ғᴏʀ sᴜᴘᴘᴏʀᴛ</a></b>",
                
                disable_web_page_preview=True)
            return
    await StreamBot.send_photo(
    chat_id=m.chat.id,
    photo="https://telegra.ph/file/857a050c16577c3f140e0.jpg",
...
async def cb_handler(client, query):
    ...
    if data == "start":
        ...
        await query.message.edit_caption(
            caption=f"<b>Mʏ ɴᴀᴍᴇ :<a href='https://t.me/kissubots'>{bot_name}</a>\nAᴅᴍɪɴ : <a href='https://t.me/xaekks'>「 𓆩•𝐊𝐢𝐬𝐬𝐮 💞•𓆪 」</a>\nʜᴏsᴛᴇᴅ ᴏɴ : ʜᴇʀᴏᴋᴜ\nᴅᴀᴛᴀʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ\nʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ 3</b>",
            reply_markup=InlineKeyboardMarkup(
                [[ 
                     InlineKeyboardButton("ʜᴏᴍᴇ", callback_data="start"),
...
[[ 
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("↼  Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ ⇀", url="t.me/kissuxbots")
                ],[
            ...
            await client.edit_message_media(
                ...
                query.message.id, 
                InputMediaPhoto(random.choice(PICS)) reply_markup = InlineKeyboardMarkup(btn)
